module Admin
  module STour
    class RemoveNotIncludedInPriceOption
      ...
      def valid_params?
        @tour and @tour.options_not_included_in_price.include?(@option)
      end

      def remove_option_from_list
        @tour.options_not_included_in_price.delete @option
        @tour.options_not_included_in_price_removed << @option
        @tour.save
      end
    end
  end
